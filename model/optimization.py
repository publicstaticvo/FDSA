...
class _LRSchedule(ABC):
    ...
    def get_lr(self, step, nowarn=False):
        ...
        if not nowarn and self.warn_t_total and progress > 1. and progress > self.warned_for_t_total_at_progress:
            logger.warning(
                "Training beyond specified 't_total'. Learning rate multiplier set to {}. Please set 't_total' of {} "
                "correctly. "
...
class BertAdam(Optimizer):
    ...
    def __init__(self, params, lr=0.0, warmup=-1, t_total=-1, schedule='warmup_linear',
